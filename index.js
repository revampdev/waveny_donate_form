var insertForm270336 = function () {
  var html270336 =
    ...
    '<option value="13324">Where It\'s Needed Most</option>' +
    '<option value="13316">Employee Fund</option>' +
    '<option value="1459200">Restricted</option>' +
    "</select>" +
    "</div>" +
    "" +
    "</div>" +
    ...
    '      <div class="field text CustomTransactionField_273408" >' +
    '<label for="CustomTransactionField_273408">In Honor Of/Memory Of</label>' +
    '<select id="CustomTransactionField_273408" name="CustomTransactionField_273408"><option value=""></option>' +
    '<option value="274432">In honor of</option>' +
    '<option value="275456">In memory of</option>' +
    "</select>" +
    "</div>" +
    '<div class="field text CustomTransactionField_276480" >' +
    '<label for="CustomTransactionField_276480"><span class="label">Name</span></label>' +
    '<input id="CustomTransactionField_276480" name="CustomTransactionField_276480" type="text" maxlength="255"></input>' +
    "</div>" +
    '<div class="field text CustomTransactionField_993280" >' +
    ...
    '<option value="1871872">Nursing</option>' +
    '<option value="1461248">Spiritual Services</option>' +
    '<option value="1566720">The Inn Activity Fund</option>' +
    '<option value="1746944">The Village</option>' +
    '<option value="995328">Therapeutic Recreation</option>' +
    '<option value="994305">Volunteer Program</option>' +
    "</select>" +
    "</div>" +
    "" +
    "</div>" +
    ...
    '<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Waveny LifeCare Network</span></label>' +
    "</div>" +
    ...
    "      <label id='noCaptchaResponseError' class='error noCaptchaResponseError' style='display: none'>You must fill out the CAPTCHA</label><div id=\"captcha270336\"></div>" +
    "" +
    "</div>" +
    '    <div class="btn-group">' +
  ...
  var successHtml270336 =
    ...
    "</div>";
  (function ($) {
    if (!Bloomerang.useDonationId("270336")) {
      html270336 =
    ...
    Bloomerang.transactionFeeEft = Bloomerang.useKey(
      "pub_d054e1d8-3552-11e9-9f3d-0aa640fb8062"
    );
      ...
      if (jQuery(".donation-form #recurring").prop("checked")) {
        ...
        if (
          ...
          Bloomerang.RecurringDonation.trueImpactEnabled(
            ...
            jQuery(".donation-form .true-impact input:checked").length > 0
          );
        }
      } else {
    ...
    jQuery.validator.addMethod(
      ...
      function (phone_number, element) {
        return (
          this.optional(element) || /^\+[0-9\-\(\)\s.]+$/i.test(phone_number)
        );
      },
    ...
    jQuery.validator.addMethod(
      ...
      function (value, element, param) {
        if (jQuery(".donation-form #other-option").prop("checked")) {
          return (
            jQuery.validator.methods.min.bind(this)(value, element, 1) &&
      ...
      if (
        ...
        selectedDonationLevel =
          selectedDonationLevel.indexOf("-") == -1
            ? ""
            : selectedDonationLevel.substr(
                selectedDonationLevel.indexOf("-") + 2
              );
